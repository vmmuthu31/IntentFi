    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-7/12 lg:w-7/12">
            <h1 className="text-7xl md:text-8xl font-light tracking-tight">
              Turn simple words 
              <br />
              into <span style={{ fontFamily: 'InstrumentSerif' }} className="text-[#FA4C15] italic">powerful DeFi
              <br />
              strategies.</span>
            </h1>
            ...
            <p className="text-gray-500 mt-10 text-lg">No gas. No code. No limits.</p>
              ...
              {/* Right column - Image */}
              <div className="w-full md:w-5/12 lg:w-5/12 mt-12 md:mt-0 overflow-hidden"> {/* Ensure ml-auto pushes the image right */}
                <Image
                  src={codeSpace}
                  alt="Code Space"
                  width={1500}
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-start justify-between gap-4">
        ...
        <div className="flex flex-col flex-1">
          <h2 className="text-3xl md:text-4xl font-serif text-orange-500 mb-6" style={{ fontFamily: 'InstrumentSerif' }}>Your intent</h2>
          <div className="mb-6">
        ...
        {/* AI Engine Section */}
        <div className="flex flex-col flex-1">
          <h2 className="text-3xl md:text-4xl font-serif text-orange-500 mb-6" style={{ fontFamily: 'InstrumentSerif' }}>Our AI engine</h2>
          <div className="mb-6">
            <p className="text-gray-400 text-lg mb-0">
        ...
        {/* Runs & Adapts Section */}
        <div className="flex flex-col flex-1">
          <h2 className="text-3xl md:text-4xl font-serif text-orange-500 mb-6" style={{ fontFamily: 'InstrumentSerif' }}>It runs, adapts &amp; grows</h2>
          <div className="mb-6">
            <p className="text-gray-400 text-lg mb-0">
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-6xl font-serif italic text-orange-500 mb-2" style={{ fontFamily: 'InstrumentSerif' }}>
            Core Capabilities That
          </h2>
          <div className="flex justify-center items-center">
            <h2 className="text-4xl md:text-6xl font-serif italic text-orange-500" style={{ fontFamily: 'InstrumentSerif' }}>
              Set Us Apart
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            <Image src={Capability1} alt="Intent-to-Action" width={400} height={400} className="mb-8 w-full" />
            {/* Intent Title */}
            <h3 className="text-2xl md:text-4xl font-serif text-orange-500 mb-4" style={{ fontFamily: 'InstrumentSerif' }}>
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            <Image src={Capability2} alt="Built-in Yielding" width={400} height={400} className="mb-8 w-full" />
            {/* Intent Title */}
            <h3 className="text-2xl md:text-4xl font-serif text-orange-500 mb-4" style={{ fontFamily: 'InstrumentSerif' }}>
        ...
        <div className="relative rounded-2xl border border-gray-800 bg-gray-900/30 p-8 overflow-visible">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mt-8 md:mt-8 md:py-10">
            ...
            <div className="max-w-md">
              <div className="text-2xl md:text-4xl font-serif text-orange-500 mb-4" style={{ fontFamily: 'InstrumentSerif' }}>
              ...
              <div className="text-white text-lg">
                IntentFi handles it all — gas-free, permissionless, and private from day one.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8 relative">
              ...
              <p className="text-white text-lg">
                IntentFi constantly checks for better APYs, risk scores, and gas routes — and updates automatically.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8 relative">
              ...
              <div className="relative z-10 top-[375px]">
                ...
                <p className="text-gray-400 mb-4 text-lg">
                  Craft strategies with clicks or schedule them for your future self.
                </p>

                <p className="text-white text-lg">
                  Build drag-and-drop logic or say things like “Stake next Friday if ETH dips below $2k.”
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto mt-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-8 max-w-xl mx-auto text-center text-lg">
            From simple prompts to powerful strategies — see how real users automate DeFi with just one command.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
          {/* Left Column - Intent-to-Action */}
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            <div className="text-2xl md:text-3xl font-serif text-orange-500 mb-4" style={{ fontFamily: 'InstrumentSerif' }}>
              01.
            </div>
            {/* Intent Title */}
            <h3 className="text-2xl md:text-3xl font-serif text-orange-500 mb-4" style={{ fontFamily: 'InstrumentSerif' }}>
              DeFi Explorer
            </h3>
            ...
            <ul className="text-white text-lg list-none">
              ...
              <li className="">
                <span className="text-xl">→</span>
                IntentFi scans top protocols, bridges funds, and autostakes via Beefy or Aave.
              </li>
              <li className="">
                <span className="text-xl">→</span>
                7.2% APY auto-compounding on Polygon — no gas, no switching wallets.
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            ...
            <ul className="text-white text-lg list-none">
              ...
              <li className="">
                <span className="text-xl">→</span>
                  IntentFi monitors RSI, triggers swaps via 1inch, and schedules weekly execution.
              </li>
              <li className="">
                <span className="text-xl">→</span>
                  Automated DCA strategy — executed gaslessly across chains every week.
              </li>
            </ul>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            ...
            <ul className="text-white text-lg list-none">
              ...
              <li className="">
                <span className="text-xl">→</span>
                  AI calculates asset split, bridges across chains, and deploys into safe protocols.
              </li>
              <li className="">
                <span className="text-xl">→</span>
                  Diversified multi-chain portfolio built and rebalanced without manual effort.
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-900/30 p-8">
            ...
            <ul className="text-white text-lg list-none">
              ...
              <li className="">
                <span className="text-xl">→</span>
                  IntentFi filters protocols by risk and APY, then allocates treasury funds safely.
              </li>
              <li className="">
                <span className="text-xl">→</span>
                  Idle DAO funds now earning low-risk yield — with full on-chain transparency
              </li>
            </ul>
          </div>
